...
#HOST = 'thingspeak.digitalgod.org:8080'

# domain for the API (used for production links)
#API_DOMAIN = 'http://thingspeak.digitalgod.org:8080/'
...
RESET_PASSWORD_URL = 'http://thingspeak.digitalgod.org:8080//users/reset_password/'
